...
MINIO_BUCKET = os.getenv("MINIO_BUCKET", "taskflow-media")
MINIO_PUBLIC_BUCKET = os.getenv("MINIO_PUBLIC_BUCKET", MINIO_BUCKET)
...
MINIO_WORKSPACE_LOGO_MAX_SIZE_MB = int(os.getenv("MINIO_WORKSPACE_LOGO_MAX_SIZE_MB", "5"))
